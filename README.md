## ⚠️ No AI-Generated Code Policy (unless...)
...
I am violating this policy in my own fork because I've been patiently waiting for a feature for more than two years. Use my AI generated slopcode at your own risk.

## Personal Todo offline restart

This branch restarts from RC3, before the retired custom offline queue, and
develops a separate durable outbox for personal Todos. See
[offline restart notes](docs/offline-restart.md) for rollback data preservation
and the acceptance criteria for the replacement Todo outbox.
